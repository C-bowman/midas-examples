from numpy import array, diagonal, eye, log, atleast_2d
...
class GaussianProcessPrior(BasePrior):
    def __init__(
        ...
        spatial_data = array([v for v in field_positions.coordinates.values()])
        spatial_data = atleast_2d(spatial_data)
